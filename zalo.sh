...
curl -L curl -L 'http://download.tensorflow.org/models/inception_resnet_v2_2016_08_30.tar.gz' -o checkpoint.tar.gz
echo 'extracting ...'
tar checkpoint.tar.gz
rm checkpoint.tar.gz
mv inception_resnet_v2_2016_08_30.ckpt inception_resnet_v2.ckpt

cd ../resnet_v2_152
echo 'Downloading resnet_v2_152 checlpoint ...'
